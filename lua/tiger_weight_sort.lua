...
local SORT_START_RANK = 8185 -- generated by src/main.py
...
local function load_weights()
	...
	for line in file:lines() do
		if in_body then
			...
			if rank >= SORT_START_RANK and code ~= nil and text ~= nil and weight ~= nil then
	...
	if log ~= nil and log.info ~= nil then
		log.info("tiger_weight_sort: loaded " .. count .. " weights from rank " .. SORT_START_RANK)
	end
end
